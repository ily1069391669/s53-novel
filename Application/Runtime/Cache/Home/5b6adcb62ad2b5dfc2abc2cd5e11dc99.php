...
<meta name="keywords" content="子不语小说网登录,帐号登录,子不语帐号" />
<meta name="description" content="子不语小说网，为你带来网络文学最新、最热、最具人气的优秀小说" />
<title>帐号登录 | 子不语小说网</title>
...
<div class="header">
  <div class="header_inner">
    <div class="logo">
      ...
      <h2><strong>子不语登录</strong><i>reg.zibuyu.com</i></h2>
    </div>
  </div>
</div> 
<link rel="stylesheet" type="text/css" href="/zyjbook/Public/Home/css/global.css?v=20160222" />
    ...
    <div class="content reg_area">
        <div class="content_inner">
            <div class="steps step2">
                <ol>
                    <li class="active" style="margin-left: 135px;"><i class="step3_icon"></i><span class="ts_txt">填写登录信息</span></li>
                </ol>
            </div>
            ...
            <div class="reg_form_box cf">
                <div class="step_cont phone_step01">
                    ...
                    <div class="form_line">
                        ...
                        <input type="submit" name="button" id="btnPhoneRegister" value="立即登录" class="btn btn_default"
