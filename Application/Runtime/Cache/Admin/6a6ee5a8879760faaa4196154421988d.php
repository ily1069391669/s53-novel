                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="<?php echo U('Manger/add');?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="lastname" name="name" class="form-control" type="text" aria-required="true" aria-invalid="false" class="valid">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">&nbsp;&nbsp;
                               <input type="radio" name="power" checked value="0">超级管理员&nbsp;&nbsp;
                               <input type="radio" name="power" value="1">管理员&nbsp;&nbsp;
                               <input type="radio" name="power" value="2">普通会员
                            </div>
                         </div>
