...
<head>
    ...
    <title>素材火www.sucaihuo.com - 布局</title>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content text-center p-md">
                                ...
                                <h2><span class="text-navy">素材火www.sucaihuo.com</span>
                    提供两种主要布局和4套皮肤可供选择</h2>
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content text-center p-md">
                                ...
                                <div class="m-t-md">
                                    ...
                                    <div class="p-lg ">
                                        <a href="index_4.html">
                                            <img class="img-responsive img-shadow" src="/novel/Public/Admin/img/index_4.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content text-center p-md">
                                ...
                                <span class="simple_tag">固定侧边栏(Fixed sidebar)</span>
                                ...
                                <div class="m-t-md">
                                    ...
                                    <div class="p-lg">
                                        <a href="index.html">
                                            <img class="img-responsive img-shadow" src="/novel/Public/Admin/img/index.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
