...
<head>
    ...
    <title>素材火www.sucaihuo.com - 基本图库</title>
    ...
    <link href="/novel/Public/Admin/js/plugins/fancybox/jquery.fancybox.css" rel="stylesheet">
...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="basic_gallery.html">基本图库</a>
                            </li>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <a class="fancybox" href="img/p1.jpg" title="图片1">
                                    <img alt="image" src="/novel/Public/Admin/img/p1.jpg" />
                                </a>
                                <a class="fancybox" href="img/p2.jpg" title="图片2">
                                    <img alt="image" src="/novel/Public/Admin/img/p2.jpg" />
                                </a>
                                <a class="fancybox" href="img/p3.jpg" title="图片3">
                                    <img alt="image" src="/novel/Public/Admin/img/p3.jpg" />
                                </a>
                                <a class="fancybox" href="img/p1.jpg" title="图片4">
                                    <img alt="image" src="/novel/Public/Admin/img/p4.jpg" />
                                </a>
                                <a class="fancybox" href="img/p2.jpg" title="图片5">
                                    <img alt="image" src="/novel/Public/Admin/img/p5.jpg" />
                                </a>
                                <a class="fancybox" href="img/p3.jpg" title="图片6">
                                    <img alt="image" src="/novel/Public/Admin/img/p6.jpg" />
                                </a>
                                <a class="fancybox" href="img/p1.jpg" title="图片7">
                                    <img alt="image" src="/novel/Public/Admin/img/p7.jpg" />
                                </a>
                                <a class="fancybox" href="img/p2.jpg" title="图片8">
                                    <img alt="image" src="/novel/Public/Admin/img/p8.jpg" />
                                </a>
    ...
    <!-- Fancy box -->
    <script src="/novel/Public/Admin/js/plugins/fancybox/jquery.fancybox.js"></script>
