...
<head>
    ...
    <title>素材火www.sucaihuo.com - Bootstrap3 表单构建器</title>
    ...
    <link href="/novel/Public/Admin/css/plugins/summernote/summernote.css" rel="stylesheet">
    <link href="/novel/Public/Admin/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
...
<body>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="form_builder.html">表单构建器</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="form_builder.html#"><i class="fa fa-bars"></i> </a>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <strong>Bootstrap3 表单构建器</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
    ...
    <!-- jQuery UI -->
    <script src="/novel/Public/Admin/js/jquery-ui-1.10.4.min.js"></script>

    <!-- From Builder -->
    <script src="/novel/Public/Admin/tools/form-builder/beautifyhtml.js"></script>
