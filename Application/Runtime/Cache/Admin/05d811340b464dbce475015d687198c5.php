...
<head>
    ...
    <link href="/novel/Public/Admin/css/plugins/chosen/chosen.css" rel="stylesheet">

    <link href="/novel/Public/Admin/css/plugins/switchery/switchery.css" rel="stylesheet">

    <link href="/novel/Public/Admin/css/plugins/jasny/jasny-bootstrap.min.css" rel="stylesheet">

    <link href="/novel/Public/Admin/css/plugins/nouslider/jquery.nouislider.css" rel="stylesheet">

    <link href="/novel/Public/Admin/css/plugins/datapicker/datepicker3.css" rel="stylesheet">

    <link href="/novel/Public/Admin/css/plugins/ionRangeSlider/ion.rangeSlider.css" rel="stylesheet">
    <link href="/novel/Public/Admin/css/plugins/ionRangeSlider/ion.rangeSlider.skinFlat.css" rel="stylesheet">

    <link href="/novel/Public/Admin/css/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
...
<body>
    ...
    <!-- Chosen -->
    <script src="/novel/Public/Admin/js/plugins/chosen/chosen.jquery.js"></script>

    <!-- JSKnob -->
    <script src="/novel/Public/Admin/js/plugins/jsKnob/jquery.knob.js"></script>

    <!-- Input Mask-->
    <script src="/novel/Public/Admin/js/plugins/jasny/jasny-bootstrap.min.js"></script>

    <!-- Data picker -->
    <script src="/novel/Public/Admin/js/plugins/datapicker/bootstrap-datepicker.js"></script>

    <!-- NouSlider -->
    <script src="/novel/Public/Admin/js/plugins/nouslider/jquery.nouislider.min.js"></script>

    <!-- Switchery -->
    <script src="/novel/Public/Admin/js/plugins/switchery/switchery.js"></script>

    <!-- IonRangeSlider -->
    <script src="/novel/Public/Admin/js/plugins/ionRangeSlider/ion.rangeSlider.min.js"></script>

    <!-- iCheck -->
    <script src="/novel/Public/Admin/js/plugins/iCheck/icheck.min.js"></script>
    ...
    <!-- COLORPICKER -->
    <script src="/novel/Public/Admin/js/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
