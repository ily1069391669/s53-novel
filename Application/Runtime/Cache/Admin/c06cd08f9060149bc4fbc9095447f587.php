        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="<?php echo U('Manger/edit');?>" method="post">
    
                      <div class="form-group">
                            <label class="col-sm-3 control-label">昵称：</label>
                            <div class="col-sm-8">
                                <input id="lastname" name="username" class="form-control" type="text" aria-required="true" aria-invalid="false" class="valid" value="<?php echo ($data["username"]); ?>">
                            </div>
                        </div> 
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-8">&nbsp;&nbsp;
                               <input type="radio" name="power"  value="0"  <?php if($data["power"] == '0' ): ?>checked<?php endif; ?>>超级管理员&nbsp;&nbsp;
                               <input type="radio" name="power" value="1"  <?php if($data["power"] == '1' ): ?>checked<?php endif; ?>>管理员&nbsp;&nbsp;
                               <input type="radio" name="power" value="2"  <?php if($data["power"] == '2' ): ?>checked<?php endif; ?>>普通会员
                            </div>
                         </div>                   
