        ...
        <div class="col-lg-6">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="<?php echo U('Novel/upload');?>" method="post" enctype="multipart/form-data">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">类别：</label>
                            <div class="col-sm-8">
                               <select name="typeid" >                              
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["type"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                             </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="lastname" name="novel_name" class="form-control" type="text" aria-required="true" aria-invalid="false" class="valid">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input  name="author" class="form-control" type="text" aria-required="true" aria-invalid="false" class="valid">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="descr"  cols="40" rows="4" style="resize:none">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-8">
                               <input type="file" name="novel_url" style="margin-top:5px;">
                            </div>
                        </div>
                            
                            
                                <input  name="addtime" class="form-control" type="hidden" value="<?php echo (NOW_TIME); ?>">
                           
                        
                        <div class="form-group">
                            <label class="col-sm-3 control-label">状态：</label>
                            <div class="col-sm-8">&nbsp;&nbsp;
                               <input type="radio" name="state" checked value="0">完结&nbsp;&nbsp;
                               <input type="radio" name="state" value="1">连载&nbsp;&nbsp;
