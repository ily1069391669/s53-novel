...
<head>
    ...
    <title>素材火www.sucaihuo.com - 基础表格</title>
    ...
    <link href="/novel/Public/Admin/css/plugins/iCheck/custom.css" rel="stylesheet">
...
<body>
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" src="/novel/Public/Admin//novel/Public/Admin/img/profile_small.jpg" />
                             </span>
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="table_basic.html">基本表格</a>
                            </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/novel/Public/Admin//novel/Public/Admin/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="/novel/Public/Admin//novel/Public/Admin/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
    ...
    <!-- Mainly scripts -->
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/jquery-2.1.1.min.js"></script>
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/bootstrap.min.js?v=3.4.0"></script>
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <!-- Peity -->
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/plugins/peity/jquery.peity.min.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/hplus.js?v=2.2.0"></script>
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/plugins/pace/pace.min.js"></script>

    <!-- iCheck -->
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/plugins/iCheck/icheck.min.js"></script>

    <!-- Peity -->
    <script src="/novel/Public/Admin//novel/Public/Admin//novel/Public/Admin/js/demo/peity-demo.js"></script>
    ...
    <script type="text/javascript" src="/novel/Public/Admin//novel/Public/Admin/http://tajs.qq.com/stats?sId=9051096" charset="UTF-8"></script><!--统计代码，可删除-->
