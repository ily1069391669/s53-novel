...
<head>
    ...
    <title>素材火www.sucaihuo.com - Toastr通知</title>
    ...
    <link href="/novel/Public/Admin/css/plugins/toastr/toastr.min.css" rel="stylesheet">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="toastr_notifications.html">Toastr通知</a>
                            </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="toastr_notifications.html#"><i class="fa fa-bars"></i> </a>
                                    ...
                                    <div class="ibox-title">
                                        ...
                                        <div class="ibox-tools">
                                            ...
                                            <ul class="dropdown-menu dropdown-user">
                                                <li><a href="toastr_notifications.html#">设置选项1</a>
                                                </li>
                                                <li><a href="toastr_notifications.html#">设置选项2</a>
                                                </li>
                                            </ul>
                                            <a class="close-link">
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
    ...
    <!-- Toastr script -->
    <script src="/novel/Public/Admin/js/plugins/toastr/toastr.min.js"></script>
