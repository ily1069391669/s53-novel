                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="widget-head-color-box navy-bg p-lg text-center">
                            ...
                            <img src="/novel/Public/Admin/img/a4.jpg" class="img-circle circle-border m-b-md" alt="profile">
                            <div>
                                <span>100 动态</span> |
                                <span>350 关注</span> |
                                <span>610 关注者</span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="ibox-content text-center">
                                        <h1>奔波儿灞</h1>
                                        <div class="m-b-sm">
                                            <img alt="image" class="img-circle" src="/novel/Public/Admin/img/a8.jpg">
                                        </div>
