...
<head>
    ...
    <title>素材火www.sucaihuo.com - 富头像上传编辑器</title>
...
<body>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="form_avatar.html">头像裁剪上传</a>
                            </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="form_avatar.html#"><i class="fa fa-bars"></i> </a>
                                ...
                                <div class="m-t m-b">
                                    ...
                                    <div id="userAlbums" style="display:none">
                                        <a href="img/a1.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a1.jpg" alt="示例图片1" />
                                        </a>
                                        <a href="img/a2.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a2.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a3.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a3.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a4.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a4.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a5.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a5.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a6.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a6.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a7.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a7.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a8.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a8.jpg" alt="示例图片2" />
                                        </a>
                                        <a href="img/a9.jpg" class="fancybox" title="选取该照片">
                                            <img src="/novel/Public/Admin/img/a9.jpg" alt="示例图片2" />
                                        </a>>
                                    </div>
                                </div>
    ...
    <!-- fullavatareditor -->
    <script type="text/javascript" src="/novel/Public/Admin/plugins/fullavatareditor/scripts/swfobject.js"></script>
    <script type="text/javascript" src="/novel/Public/Admin/plugins/fullavatareditor/scripts/fullAvatarEditor.js"></script>
    <script type="text/javascript" src="/novel/Public/Admin/plugins/fullavatareditor/scripts/jQuery.Cookie.js"></script>
    <script type="text/javascript" src="/novel/Public/Admin/plugins/fullavatareditor/scripts/test.js"></script>
