...
<head>
    ...
    <title>素材火www.sucaihuo.com - 文件上传</title>
    ...
    <link href="/novel/Public/Admin/css/plugins/dropzone/basic.css" rel="stylesheet">
    <link href="/novel/Public/Admin/css/plugins/dropzone/dropzone.css" rel="stylesheet">
...
<body>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li class="active"><a href="form_file_upload.html">文件上传</a>
                            </li>
    ...
    <!-- DROPZONE -->
    <script src="/novel/Public/Admin/js/plugins/dropzone/dropzone.js"></script>
